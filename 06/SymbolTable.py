...
class SymbolTable:
    ...
    def __init__(self) -> None:
        ...
        book.
        """
        self.__table = SymbolTable.__init_table.copy()
        self.__free_address = SymbolTable.init_free_address
    ...
    def add_entry(self, symbol: str, address: int) -> None:
        ...
        if address == -1:
            self.__table[symbol] = self.__free_address
